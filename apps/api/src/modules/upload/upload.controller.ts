...
// Primer filtro barato por mimetype declarado. La validación fuerte (magic
// bytes + extensión segura) la hace StorageService.saveFile, que protege a
// todos los módulos que suben archivos por igual.
const upload = multer({
