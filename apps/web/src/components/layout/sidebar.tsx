...
import {
  ...
  ChevronLeft, Sparkles, Lock, Building2, DollarSign, Store, ShoppingBag, Star, Upload, Megaphone, Shield, Percent,
} from 'lucide-react';

const iconMap: Record<string, any> = {
  Home, Package, ShoppingCart, Calendar, BookOpen, Palette,
  Users, Truck, BarChart3, Wallet, UserCog, Bot, Settings, DollarSign, Store, ShoppingBag, Star, Upload, Megaphone, Shield, Percent,
};
