          ...
          <div className="flex-1 min-w-0 max-w-xl">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Buscar..."
                className="w-full pl-9 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-[#EF2D8F]/30 focus:border-[#EF2D8F]/50"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {mounted && isAuthenticated && user?.role === 'customer' ? (
              ...
              <Link
                ...
                className="flex items-center gap-1.5 px-3 sm:px-4 py-2 bg-[#EF2D8F] text-white rounded-full text-sm font-semibold hover:bg-[#d4267e] transition"
              >
