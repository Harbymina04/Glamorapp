    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Historial consolidado de todas las sucursales</p>
        </div>
      </div>

      <AuditLogTable
        endpoint="/tenant/audit-logs"
        token={token}
        showStoreFilter
        modulesEndpoint="/tenant/audit-logs/modules"
      />
    </div>
  );
}
